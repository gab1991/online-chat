...
export default function Login(props) {
	...
	const [inputs, setInputs] = useState({
		...
		password: {
			...
			value: '',
			valid: false,
			invalidMessage: 'Password must contain 4 to 15 chars including at least one number',
			icon: <KeyIcon />,
		},
	});
	...
	return (
		<div className={`${styles.Login}`}>
			...
			<form className={styles.Form} onSubmit={submitHandler}>
				...
				<Checkbox txt={`Remember me`} className={styles.Checkbox} onChange={rememberUser} checked={saveUser} />
